...
export default function Home () {
  ...
  return (
    <section
      className="flex flex-col items-center mt-32.5 gap-45.5 cursor-pointer"
      onClick={navToLogin}
    >
    ...
    <main className="text-center">
      ...
      <h2 className="text-primary animate-pulse">Clique na tela para iniciar.</h2>
    </main>
    <footer className="absolute flex justify-end align-bottom w-full h-127 right-0 left-0 bottom-0 overflow-hidden">
      <img
        className="w-full object-cover right-0 bottom-0 object-top"
        src={footerImg}
